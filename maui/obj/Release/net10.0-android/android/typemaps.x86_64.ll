...
; Strings
@.tmr.0 = private unnamed_addr constant [24 x i8] c"android/widget/TextView\00", align 16
@.tmr.1 = private unnamed_addr constant [28 x i8] c"android/widget/LinearLayout\00", align 16
@.tmr.2 = private unnamed_addr constant [41 x i8] c"android/widget/LinearLayout$LayoutParams\00", align 16
@.tmr.3 = private unnamed_addr constant [26 x i8] c"android/util/AttributeSet\00", align 16
@.tmr.4 = private unnamed_addr constant [19 x i8] c"android/os/Handler\00", align 16
@.tmr.5 = private unnamed_addr constant [22 x i8] c"android/os/BaseBundle\00", align 16
@.tmr.6 = private unnamed_addr constant [18 x i8] c"android/os/Bundle\00", align 16
@.tmr.7 = private unnamed_addr constant [18 x i8] c"android/os/Looper\00", align 16
@.tmr.8 = private unnamed_addr constant [20 x i8] c"android/media/Image\00", align 16
@.tmr.9 = private unnamed_addr constant [26 x i8] c"android/media/Image$Plane\00", align 16
@.tmr.10 = private unnamed_addr constant [26 x i8] c"android/media/ImageReader\00", align 16
@.tmr.11 = private unnamed_addr constant [51 x i8] c"android/media/ImageReader$OnImageAvailableListener\00", align 16
@.tmr.12 = private unnamed_addr constant [18 x i8] c"android/view/View\00", align 16
@.tmr.13 = private unnamed_addr constant [33 x i8] c"android/view/ContextThemeWrapper\00", align 16
@.tmr.14 = private unnamed_addr constant [21 x i8] c"android/view/Surface\00", align 16
@.tmr.15 = private unnamed_addr constant [28 x i8] c"android/view/SurfaceControl\00", align 16
@.tmr.16 = private unnamed_addr constant [23 x i8] c"android/view/ViewGroup\00", align 16
@.tmr.17 = private unnamed_addr constant [36 x i8] c"android/view/ViewGroup$LayoutParams\00", align 16
@.tmr.18 = private unnamed_addr constant [42 x i8] c"android/view/ViewGroup$MarginLayoutParams\00", align 16
@.tmr.19 = private unnamed_addr constant [40 x i8] c"mono/android/runtime/InputStreamAdapter\00", align 16
@.tmr.20 = private unnamed_addr constant [31 x i8] c"mono/android/runtime/JavaArray\00", align 16
@.tmr.21 = private unnamed_addr constant [21 x i8] c"java/util/Collection\00", align 16
@.tmr.22 = private unnamed_addr constant [18 x i8] c"java/util/HashMap\00", align 16
@.tmr.23 = private unnamed_addr constant [20 x i8] c"java/util/ArrayList\00", align 16
@.tmr.24 = private unnamed_addr constant [32 x i8] c"mono/android/runtime/JavaObject\00", align 16
@.tmr.25 = private unnamed_addr constant [35 x i8] c"android/runtime/JavaProxyThrowable\00", align 16
@.tmr.26 = private unnamed_addr constant [18 x i8] c"java/util/HashSet\00", align 16
@.tmr.27 = private unnamed_addr constant [41 x i8] c"mono/android/runtime/OutputStreamAdapter\00", align 16
@.tmr.28 = private unnamed_addr constant [29 x i8] c"android/net/wifi/WifiManager\00", align 16
@.tmr.29 = private unnamed_addr constant [26 x i8] c"android/net/wifi/WifiInfo\00", align 16
@.tmr.30 = private unnamed_addr constant [31 x i8] c"android/hardware/SensorManager\00", align 16
@.tmr.31 = private unnamed_addr constant [37 x i8] c"android/hardware/SensorEventListener\00", align 16
@.tmr.32 = private unnamed_addr constant [24 x i8] c"android/hardware/Sensor\00", align 16
@.tmr.33 = private unnamed_addr constant [29 x i8] c"android/hardware/SensorEvent\00", align 16
@.tmr.34 = private unnamed_addr constant [46 x i8] c"android/hardware/camera2/CameraCaptureSession\00", align 16
@.tmr.35 = private unnamed_addr constant [62 x i8] c"android/hardware/camera2/CameraCaptureSession$CaptureCallback\00", align 16
@.tmr.36 = private unnamed_addr constant [60 x i8] c"android/hardware/camera2/CameraCaptureSession$StateCallback\00", align 16
@.tmr.37 = private unnamed_addr constant [38 x i8] c"android/hardware/camera2/CameraDevice\00", align 16
@.tmr.38 = private unnamed_addr constant [52 x i8] c"android/hardware/camera2/CameraDevice$StateCallback\00", align 16
@.tmr.39 = private unnamed_addr constant [39 x i8] c"android/hardware/camera2/CameraManager\00", align 16
@.tmr.40 = private unnamed_addr constant [40 x i8] c"android/hardware/camera2/CameraMetadata\00", align 16
@.tmr.41 = private unnamed_addr constant [40 x i8] c"android/hardware/camera2/CaptureRequest\00", align 16
@.tmr.42 = private unnamed_addr constant [48 x i8] c"android/hardware/camera2/CaptureRequest$Builder\00", align 16
@.tmr.43 = private unnamed_addr constant [32 x i8] c"android/graphics/SurfaceTexture\00", align 16
@.tmr.44 = private unnamed_addr constant [26 x i8] c"android/graphics/Typeface\00", align 16
@.tmr.45 = private unnamed_addr constant [24 x i8] c"android/content/Context\00", align 16
@.tmr.46 = private unnamed_addr constant [31 x i8] c"android/content/ContextWrapper\00", align 16
@.tmr.47 = private unnamed_addr constant [21 x i8] c"android/app/Activity\00", align 16
@.tmr.48 = private unnamed_addr constant [24 x i8] c"android/app/Application\00", align 16
@.tmr.49 = private unnamed_addr constant [16 x i8] c"java/nio/Buffer\00", align 16
@.tmr.50 = private unnamed_addr constant [20 x i8] c"java/nio/ByteBuffer\00", align 16
@.tmr.51 = private unnamed_addr constant [30 x i8] c"java/nio/channels/FileChannel\00", align 16
@.tmr.52 = private unnamed_addr constant [51 x i8] c"java/nio/channels/spi/AbstractInterruptibleChannel\00", align 16
@.tmr.53 = private unnamed_addr constant [24 x i8] c"java/io/FileInputStream\00", align 16
@.tmr.54 = private unnamed_addr constant [20 x i8] c"java/io/InputStream\00", align 16
@.tmr.55 = private unnamed_addr constant [20 x i8] c"java/io/IOException\00", align 16
@.tmr.56 = private unnamed_addr constant [21 x i8] c"java/io/OutputStream\00", align 16
@.tmr.57 = private unnamed_addr constant [19 x i8] c"java/util/Iterator\00", align 16
@.tmr.58 = private unnamed_addr constant [28 x i8] c"java/util/function/Consumer\00", align 16
@.tmr.59 = private unnamed_addr constant [18 x i8] c"java/lang/Boolean\00", align 16
@.tmr.60 = private unnamed_addr constant [15 x i8] c"java/lang/Byte\00", align 1
@.tmr.61 = private unnamed_addr constant [20 x i8] c"java/lang/Character\00", align 16
@.tmr.62 = private unnamed_addr constant [16 x i8] c"java/lang/Class\00", align 16
@.tmr.63 = private unnamed_addr constant [33 x i8] c"java/lang/ClassNotFoundException\00", align 16
@.tmr.64 = private unnamed_addr constant [17 x i8] c"java/lang/Double\00", align 16
@.tmr.65 = private unnamed_addr constant [20 x i8] c"java/lang/Exception\00", align 16
@.tmr.66 = private unnamed_addr constant [16 x i8] c"java/lang/Float\00", align 16
@.tmr.67 = private unnamed_addr constant [18 x i8] c"java/lang/Integer\00", align 16
@.tmr.68 = private unnamed_addr constant [15 x i8] c"java/lang/Long\00", align 1
@.tmr.69 = private unnamed_addr constant [17 x i8] c"java/lang/Object\00", align 16
@.tmr.70 = private unnamed_addr constant [27 x i8] c"java/lang/RuntimeException\00", align 16
@.tmr.71 = private unnamed_addr constant [16 x i8] c"java/lang/Short\00", align 16
@.tmr.72 = private unnamed_addr constant [17 x i8] c"java/lang/String\00", align 16
@.tmr.73 = private unnamed_addr constant [17 x i8] c"java/lang/Thread\00", align 16
@.tmr.74 = private unnamed_addr constant [35 x i8] c"mono/java/lang/RunnableImplementor\00", align 16
@.tmr.75 = private unnamed_addr constant [20 x i8] c"java/lang/Throwable\00", align 16
@.tmr.76 = private unnamed_addr constant [29 x i8] c"java/lang/ClassCastException\00", align 16
@.tmr.77 = private unnamed_addr constant [16 x i8] c"java/lang/Error\00", align 16
@.tmr.78 = private unnamed_addr constant [23 x i8] c"java/lang/CharSequence\00", align 16
@.tmr.79 = private unnamed_addr constant [35 x i8] c"java/lang/IllegalArgumentException\00", align 16
@.tmr.80 = private unnamed_addr constant [32 x i8] c"java/lang/IllegalStateException\00", align 16
@.tmr.81 = private unnamed_addr constant [36 x i8] c"java/lang/IndexOutOfBoundsException\00", align 16
@.tmr.82 = private unnamed_addr constant [19 x i8] c"java/lang/Runnable\00", align 16
@.tmr.83 = private unnamed_addr constant [23 x i8] c"java/lang/LinkageError\00", align 16
@.tmr.84 = private unnamed_addr constant [31 x i8] c"java/lang/NoClassDefFoundError\00", align 16
@.tmr.85 = private unnamed_addr constant [31 x i8] c"java/lang/NullPointerException\00", align 16
@.tmr.86 = private unnamed_addr constant [17 x i8] c"java/lang/Number\00", align 16
@.tmr.87 = private unnamed_addr constant [39 x i8] c"java/lang/ReflectiveOperationException\00", align 16
@.tmr.88 = private unnamed_addr constant [28 x i8] c"java/lang/StackTraceElement\00", align 16
@.tmr.89 = private unnamed_addr constant [40 x i8] c"java/lang/UnsupportedOperationException\00", align 16
@.tmr.90 = private unnamed_addr constant [25 x i8] c"mono/android/TypeManager\00", align 16
@.tmr.91 = private unnamed_addr constant [20 x i8] c"[Ljava/lang/Object;\00", align 16
...
@.tmr.100 = private unnamed_addr constant [37 x i8] c"net/dot/jni/internal/JavaProxyObject\00", align 16
@.tmr.101 = private unnamed_addr constant [40 x i8] c"net/dot/jni/internal/JavaProxyThrowable\00", align 16
@.tmr.102 = private unnamed_addr constant [24 x i8] c"net/dot/jni/ManagedPeer\00", align 16
@.tmr.103 = private unnamed_addr constant [35 x i8] c"crc64ebab215de862fb6d/MainActivity\00", align 16
@.tmr.104 = private unnamed_addr constant [50 x i8] c"crc642bf9dc2dd4ff72c8/CameraService_ImageListener\00", align 16
@.tmr.105 = private unnamed_addr constant [56 x i8] c"crc642bf9dc2dd4ff72c8/CameraService_CameraStateCallback\00", align 16
@.tmr.106 = private unnamed_addr constant [52 x i8] c"crc642bf9dc2dd4ff72c8/CameraService_SessionCallback\00", align 16
@.tmr.107 = private unnamed_addr constant [36 x i8] c"crc642bf9dc2dd4ff72c8/SensorService\00", align 16
