...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [33 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		i32 1601536, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 2680832; uint32_t buffer_offset
	}, ; 30: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 11776, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 2842624; uint32_t buffer_offset
	}, ; 31: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 342016, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 2854400; uint32_t buffer_offset
	} ; 32: Mono.Android
], align 16

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 3196416, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [3196416 x i8] zeroinitializer, align 16
