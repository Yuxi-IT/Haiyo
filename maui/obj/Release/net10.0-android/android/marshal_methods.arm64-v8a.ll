...
@assembly_image_cache = dso_local local_unnamed_addr global [33 x ptr] zeroinitializer, align 8
...
@.mm.5 = private unnamed_addr constant [140 x i8] c"Android.Media.ImageReader/IOnImageAvailableListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065\00", align 1
@.mm.6 = private unnamed_addr constant [133 x i8] c"Android.Hardware.Camera2.CameraDevice/StateCallback, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065\00", align 1
@.mm.7 = private unnamed_addr constant [141 x i8] c"Android.Hardware.Camera2.CameraCaptureSession/StateCallback, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065\00", align 1
@.mm.8 = private unnamed_addr constant [126 x i8] c"Android.Hardware.ISensorEventListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065\00", align 1
@.mm.9 = private unnamed_addr constant [122 x i8] c"Java.Interop.TypeManager/JavaTypeManager, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065\00", align 1
@.mm.10 = private unnamed_addr constant [40 x i8] c"get_function_pointer MUST be specified\0A\00", align 1
...
@.MarshalMethodName.13_name = private unnamed_addr constant [106 x i8] c"n_OnRequestPermissionsResult_IarrayLjava_lang_String_arrayI_mm_wrapper(IntPtr,IntPtr,Int32,IntPtr,IntPtr)\00", align 1
@.MarshalMethodName.14_name = private unnamed_addr constant [38 x i8] c"n_OnDestroy_mm_wrapper(IntPtr,IntPtr)\00", align 1
@.MarshalMethodName.15_name = private unnamed_addr constant [80 x i8] c"n_OnImageAvailable_Landroid_media_ImageReader__mm_wrapper(IntPtr,IntPtr,IntPtr)\00", align 1
@.MarshalMethodName.16_name = private unnamed_addr constant [84 x i8] c"n_OnOpened_Landroid_hardware_camera2_CameraDevice__mm_wrapper(IntPtr,IntPtr,IntPtr)\00", align 1
@.MarshalMethodName.17_name = private unnamed_addr constant [90 x i8] c"n_OnDisconnected_Landroid_hardware_camera2_CameraDevice__mm_wrapper(IntPtr,IntPtr,IntPtr)\00", align 1
@.MarshalMethodName.18_name = private unnamed_addr constant [90 x i8] c"n_OnError_Landroid_hardware_camera2_CameraDevice_I_mm_wrapper(IntPtr,IntPtr,IntPtr,Int32)\00", align 1
@.MarshalMethodName.19_name = private unnamed_addr constant [96 x i8] c"n_OnConfigured_Landroid_hardware_camera2_CameraCaptureSession__mm_wrapper(IntPtr,IntPtr,IntPtr)\00", align 1
@.MarshalMethodName.20_name = private unnamed_addr constant [101 x i8] c"n_OnConfigureFailed_Landroid_hardware_camera2_CameraCaptureSession__mm_wrapper(IntPtr,IntPtr,IntPtr)\00", align 1
@.MarshalMethodName.21_name = private unnamed_addr constant [86 x i8] c"n_OnAccuracyChanged_Landroid_hardware_Sensor_I_mm_wrapper(IntPtr,IntPtr,IntPtr,Int32)\00", align 1
@.MarshalMethodName.22_name = private unnamed_addr constant [82 x i8] c"n_OnSensorChanged_Landroid_hardware_SensorEvent__mm_wrapper(IntPtr,IntPtr,IntPtr)\00", align 1
@.MarshalMethodName.23_name = private unnamed_addr constant [57 x i8] c"n_Activate_mm(IntPtr,IntPtr,IntPtr,IntPtr,IntPtr,IntPtr)\00", align 1
